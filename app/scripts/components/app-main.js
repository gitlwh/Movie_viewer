...
class App extends Component {
  ...
  fetchMovieID(movieID) {
    let url = `https://api.themoviedb.org/3/movie/${movieID}?&api_key=42e30c2af7a99bf72c6193c487c7020e`
    this.fetchApi(url)
  } // end function

  componentDidMount() {
    let url = `https://api.themoviedb.org/3/movie/${this.state.movieID}?&api_key=42e30c2af7a99bf72c6193c487c7020e`
    this.fetchApi(url)
